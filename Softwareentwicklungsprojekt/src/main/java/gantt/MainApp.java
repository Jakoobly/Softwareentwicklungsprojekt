...
/* hier startet das Programm -> erstellt den Plan, erzeugt die View (damit man was sieht),
erzeugt die stage
 */
...
public class MainApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        plan = new Plan(
                LocalTime.of(6, 0),
                LocalTime.of(18, 0),
                List.of("Arbeitszug", "1a", "1b", "2", "3", "4", "5", "6", "7"),
                List.of(
        ...
        Gantt chartView = new Gantt(plan);

        Scene scene = new Scene(chartView, 1100, 600);
